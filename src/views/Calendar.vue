...
<template>
  <div style="margin-left:2vw">
    <v-row>
      <v-col sm="12" lg="2" class="mb-4 controls">
        <v-btn fab outlined small absolute left color="primary" @click="$refs.calendar.prev()">
          <v-icon dark>mdi-chevron-left</v-icon>
        </v-btn>
        <h4>{{Month}}</h4>
        <v-btn fab outlined small absolute right color="primary" @click="$refs.calendar.next()">
        ...
        <v-sheet height="500">
          ...
          >
            <template v-slot:day="day">
              ...
              >Lab 1 CSCI203</v-sheet>
            </template>
            <template v-slot:header="day">
              <div v-if="day.weekday % 2" class="day-header">Lab 2 CSIT315</div>
            </template>
            <template v-slot:day-body="day">
              <div v-if="day.weekday % 3 === 2" class="day-body">Assignment 1 CSCI111</div>
            </template>
          </v-calendar>
        </v-sheet>
      </v-col>
